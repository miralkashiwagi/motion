...
<IframeDemo title="ハンバーガーメニューアニメーション" description="クリックするとアイコンが×に変化するシンプルなアニメーション" />

## 概要

ハンバーガーメニューは、モバイルサイトやレスポンシブデザインで広く使用されているUIパターンです。
このサンプルでは、クリックするとハンバーガーアイコンが×マークに変化するシンプルなアニメーションを実装しています。
