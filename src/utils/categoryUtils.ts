...
function getIconSvg(iconName: string): string {
  ...
  const iconMap: Record<string, string> = {
    ...
    'question-mark': `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75c1.5 0 2.25.75 2.25 2.25s-.75 2.25-2.25 2.25-2.25-.75-2.25-2.25S10.5 6.75 12 6.75ZM12 15v3m0-3a4.5 4.5 0 1 1-4.5-4.5A4.5 4.5 0 0 1 12 15Z" />
     </svg>`,
  };
